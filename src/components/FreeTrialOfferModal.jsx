...
const FreeTrialOfferModal = ({ show, onClose, onClaim }) => {
    if (!show) return null;
                ...
                <div className="relative bg-gradient-to-r from-blue-600 via-purple-600 to-blue-700 p-4">
                    ...
                    <div className="relative text-center">
                        ...
                        <p className="text-blue-100/90 text-xs font-medium">
                            Your one-day free trial awaits
                        </p>
                    </div>
                </div>
                    ...
                    <div className="bg-white rounded-lg shadow-md p-4 border border-gray-100">
                        <div className="space-y-4">
                            <p className="text-sm text-gray-700 font-medium text-center">
                                We're giving you a **one-day free trial** to explore all of our premium courses. Get full access to every video and unlock your potential!
                            </p>
                            <button
                                type="button"
                                onClick={onClaim}
...
export default FreeTrialOfferModal;